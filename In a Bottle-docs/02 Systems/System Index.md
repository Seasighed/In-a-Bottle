...
Use this section for architecture, services, pipelines, integrations, and cross-cutting technical systems.

## Good Fits

- Rendering or asset pipelines
- Data storage and persistence layers
- External tool or API integrations
- Capture, build, export, or automation systems
- Shared service layers and coordination flows
...
- 2026-05-09 02:52 - Created the system index.
