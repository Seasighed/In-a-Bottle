...
Use this section for concise user-facing notes, operator instructions, onboarding notes, and behavior changes people should know about.

## Good Fits

- How to use a feature
- What changed in a workflow
- Setup or operating instructions
- Known limitations a user should expect
...
- 2026-05-09 02:52 - Created the user note index.
