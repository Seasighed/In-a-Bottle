...
- Curation was completed in the safety clone at `build/commit-workspace/In-a-Bottle-rc-commits` on branch `codex-release-candidate-proof-pass`; the branch was pushed to GitHub and the verified bundle backup is `build/commit-workspace/codex-release-candidate-proof-pass-latest.bundle`.
- The release manifest in `build/playtest/20260630-promoted-branch-proof` records the exact promoted branch HEAD used for final local proof.
...
- 2026-06-30 21:21 - Recorded the GitHub branch promotion and final promoted-branch proof manifest location.
