...
| --- | --- | --- | --- |
| Dirty worktree curation | Safe in clone | [Public Launch Worktree Curation](Public%20Launch%20Worktree%20Curation.md) plus commits | Clean safety branch `codex-release-candidate-proof-pass` exists at `build/commit-workspace/In-a-Bottle-rc-commits`; foreground checkout still cannot write `.git` refs. |
...
| Supabase local validation | Blocked locally | Deno tests and checks pass | `deno.exe` is installed through WinGet but still returns Access denied from this session as of 2026-06-30 04:50. |
...
| Public web build | Packaged locally | `build/playtest/20260630-044822/release_manifest.json` points at `web/participant` | Final local release package was generated from clean commit `a42d69e03b5f143e39baf6244fb4c2e3f50700a1`. |
| Windows builds | Packaged locally | Participant and QA folders exist under `build/playtest/20260630-044822` | Built by `tools/playtest.ps1 release -IncludeAudit`. |
| Visual audit proof | Passed locally | Renderer-backed audit has zero placeholder captures | Final audit copied `build/playtest/20260630-044822/audit/survey_visual_audit_2026-06-30t08-48-59.zip` with 92 captures and 0 placeholders. |
...
- Final safety-clone release folder: `build/playtest/20260630-044822`
- Final safety-clone release manifest: `build/playtest/20260630-044822/release_manifest.json`
- Final safety-clone renderer audit ZIP: `build/playtest/20260630-044822/audit/survey_visual_audit_2026-06-30t08-48-59.zip`
