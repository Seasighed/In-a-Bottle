...
func _ready() -> void:
	...
	for button in [_close_button, _theme_toggle_button, _remember_onboarding_checkbox, _local_session_cache_checkbox]:
...
func open_settings(use_dark_mode: bool, current_sfx_volume: float, remember_onboarding: bool, allow_local_session_cache: bool) -> void:
